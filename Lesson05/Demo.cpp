...
void Demo::Update(double deltaTime) {
	...
	if (p != 1000) {
		tempX = xPositition[p] - ss1;
		tempZ = zPositition[p] - ss3;
...
void Demo::Render() {
	...
	DrawColoredCube(1, 0, 6, 0.1, 5, 0.5, 0.8);
	DrawColoredCube(2, 5, 3, 0.1, 0.5, 0.5, 3);
	DrawColoredCube(2, 5, 3, 0.1, 0.5, 3, 0.5);
	DrawColoredPlane();
