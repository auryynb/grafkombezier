...
void Demo::Update(double deltaTime) {
	angle1 += (float)((deltaTime * 1.0f) / 70);
	angle2 += (float)((deltaTime * 1.0f) / 70);
...
void Demo::Render() {
	...
	glm::mat4 view = glm::lookAt(glm::vec3(20 + ss1, 25, 5 + ss3), glm::vec3(-15, -30, 0), glm::vec3(0, 1, 0));
	GLint viewLoc = glGetUniformLocation(this->shaderProgram, "view");
	glUniformMatrix4fv(viewLoc, 1, GL_FALSE, glm::value_ptr(view));


	DrawColoredCube(0, 0, 3, 0, 3, 3, 3);
	DrawColoredCube(0, 2.5, 3, 0, 5, 1, 1);
	DrawColoredCube(0, 0, 5, 0, 1, 1, 1);
	//atas
	DrawColoredCube(1, 0, 6, 0.1, 6, 0.5, 0.5);
	DrawColoredCube(1, 0, 6, 0.1, 0.5, 0.5, 6);
	//belakang
	DrawColoredCube(3, 5, 3, 0.8, 3, 0.5, 0.5);
	DrawColoredCube(3, 5, 3, 0.8, 0.5, 3, 0.5);
...
void Demo::BuildColoredPlane()
{
	...
	GLfloat vertices[] = {
		...
		// bottom
		-200.0, -0.5, -200.0,  0,  0,
		 200.0, -0.5, -200.0, 200,  0,
		 200.0, -0.5,  200.0, 200, 200,
		-200.0, -0.5,  200.0,  0, 200,
...
void Demo::bezierInit() {
	...
	for (int i = 0; i < segmentCount; i++) {
		...
		z = ((1 - t) * (1 - t) * p0z) + (2 * (1 - t) * t * p1z) + (t * t * p2z);
